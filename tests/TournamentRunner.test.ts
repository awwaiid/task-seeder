...
describe('TournamentRunner', () => {
  ...
  describe('QuickSort Tournament', () => {
    ...
    it('should return first comparison for 3-participant tournament', () => {
      ...
      expect(['Alice', 'Charlie']).toContain(
        match!.player1 === 'Bob' ? match!.player2 : match!.player1
      );
    });
    ...
    it('should track progress correctly', () => {
      const tournament = new QuickSortTournament([
        'Alice',
        'Bob',
        'Charlie',
        'Diana',
  ...
  describe('Tournament Factory', () => {
    ...
    it('should create double elimination tournament', () => {
      const tournament = createTournament('double', [
        'Alice',
        'Bob',
        'Charlie',
        'Diana',
    ...
    it('should create quicksort tournament', () => {
      const tournament = createTournament('quicksort', [
        'Alice',
        'Bob',
        'Charlie',
      ]);
