  ...
  <div id="app">
    <header class="app-header">
      ...
      <nav class="header-nav">
        <a href="#" @click.prevent="showAbout" class="nav-link">About</a>
        <a href="https://github.com/awwaiid/task-seeder/discussions" target="_blank" class="nav-link">Feedback</a>
        <a href="https://github.com/awwaiid/task-seeder" target="_blank" class="nav-link github-link" title="View on GitHub">
    ...
    <TournamentManager v-if="currentView === 'main'" ref="tournamentManagerRef" />
