<template>
  <!-- Setup Phase -->
  <div v-if="currentPhase === 'setup'" class="container">
    ...
    <div
      v-if="loadedFromURL && currentPhase === 'setup'"
      style="
        margin-bottom: 20px;
        padding: 15px;
    ...
    >
      ...
      <button
        style="
          ...
          margin-right: 10px;
        "
        @click="saveCurrentBracketLocally"
      >
        💾 Save Locally
      </button>
      <button
    ...
    >
      ...
      <button
        ...
        "
        title="Dismiss"
        @click="showAutoSaveNotice = false"
      >
        ✕
      </button>
    </div>
